    ...
    */}
        ...
        <section className='z-5 mx-32'>
            <div className='inline-block text-white mt-16 w-full whitespace-no-wrap overflow-x-scroll font-semibold text-3xl'>
                <a href='#' className='mx-16 hover:text-gray-600'>Magic</a>
                <a href='#' className='mx-16 hover:text-gray-600'>Innovation and Technology</a>
                <a href='#' className='mx-16 hover:text-gray-600'>Magic</a>
                <a href='#' className='mx-16 hover:text-gray-600'>Web Development</a>
            </div>
