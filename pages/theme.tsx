    ...
    <div className='px-32'>
      ...
      <section className='py-6'>
        <div className='flex content-center justify-center bg-blue-600'>
          <div className='py-8 text-white text-8xl font-bold'>Theme UI</div>
        </div>
      </section>
            ...
            <div className='flex flex-col'>
              ...
              <div className='flex flex-row'>
                <div className='mt-3 rounded border-2 bg-yellow-500 border-yellow-500'>
                  <div className='text-black font-bold text-center'>#cool</div>
                </div>
      ...
      <section className='pt-8 text-gray-300 font-semibold text-3xl'>
        ...
        local communities, communications, promotion, education, funding open
        source initiatives and advocacy.<br></br>Tezos Commons supports the
        ideas, individuals and organizations dedicated to building the digital
        commonwealth.<br></br>
        <br></br>We empower the community to be the architects through
        bootstrapping local communities, communications, promotion, education,
        funding open source initiatives and advocacy.<br></br>
        <br></br>
        Tezos Commons supports the ideas, individuals and organizations
        dedicated to building the digital commonwealth.<br></br>
        <br></br>
        ...
        local communities, communications, promotion, education, funding open
        source initiatives and advocacy.<br></br>Tezos Commons supports the
        ideas, individuals and orgnizations dedicated to building the digital
        commonwealth.<br></br>
        <br></br>We empower the community to be the architects through
        bootstrapping local communities, communications, promotion, education,
        funding open source initiatives and advocacy.
      </section>
    </div>
